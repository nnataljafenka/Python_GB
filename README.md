# Практические задания по курсу GB "Основы Python"
  
	Lesson 1. Знакомство с Python
	Lesson 2. Встроенные типы и операции с ними
	Lesson 3. Функции
	Lesson 4. Полезные инструменты
	Lesson 5. Работа с файлами
	Lesson 6. Объектно-ориентированное программирование
	Lesson 7. ООП. Продвинутый уровень
 	Lesson 8. Знакомство с Python
 	Lesson 9. ООП. Полезные дополнения
